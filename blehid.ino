...
char kbd[] = "DontTouchMe"; //Device Name
...
bleKeyboard.releaseAll();
delay(1000);
const char* txt = "We're Cysec. Join us now!";
...
bleKeyboard.releaseAll();
delay(5000);
const char* cmd = "cowsay \"You're gay\"";
...
if (lastState3 == HIGH && state3 == LOW) {
  ...
  const char* cmd = "https://zendexsite.netlify.app/homepage/home.mp4";
  for (int i = 0; i < strlen(cmd); i++) {
    bleKeyboard.print(cmd[i]);
    delay(10);
  }
